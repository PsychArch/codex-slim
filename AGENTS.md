...
```sh
make build CODEX_VERSION=0.129.0
make smoke CODEX_VERSION=0.129.0
```
...
```sh
git tag v0.129.0
git push origin v0.129.0
```

The published image tags are `latest` and the Codex version without the leading `v`, for example `0.129.0`.
